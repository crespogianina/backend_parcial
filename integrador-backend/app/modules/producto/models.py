...
from sqlmodel import ARRAY, Column, Numeric, SQLModel, Field, Relationship, String
...
class Producto(SQLModel, table=True):
    ...
    precio_base: Decimal = Field(sa_column=Column(Numeric(10,2)),ge=0 ,nullable=False)
